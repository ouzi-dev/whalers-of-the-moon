...
| -------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `golang:1.13.8-alpine3.11` | None       | * curl<br> * make<br> * bash<br> * git<br> * nodejs<br> * npn<br> * golagci-lint<br> * gox<br> * goimports<br> * gomock<br> * mockgen<br> * zip | [Dockerfile](./go-builder/Dockerfile) |
...
* `GOLANG_VERSION`: Go version to use as base image. Default value: `1.13.8`
...
* `GO_BUILDER_TAG`: Go-Builder tag to use as base image. Default value: `1.13.7`
* `HELM_VERSION`: Version to install of `helm`. Default value: `v3.0.3`
